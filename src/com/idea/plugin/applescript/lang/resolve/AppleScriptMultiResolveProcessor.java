 ...
 */
public class AppleScriptMultiResolveProcessor extends AppleScriptPsiScopeProcessor {
  private final List<AppleScriptComponent> myResult;
  private final String myName;

  public AppleScriptMultiResolveProcessor(List<AppleScriptComponent> result, String name) {
    myResult = result;
    myName = name;
  }
