...
//            else
    ...
    if (!r && ApplicationDictionary.STANDARD_ADDITIONS_LIBRARY.equals(toldApplicationName)) {
...
//    }
    ...
    return r || parameter.isOptional() || b.getUserData(IS_PARSING_TELL_COMPOUND_STATEMENT) == Boolean.TRUE;
  }
