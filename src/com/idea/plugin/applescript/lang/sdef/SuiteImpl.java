...
public class SuiteImpl extends FakePsiElement implements Suite {
  ...
  public SuiteImpl(@NotNull String code, @NotNull String name, boolean hidden, @Nullable String description, @NotNull
