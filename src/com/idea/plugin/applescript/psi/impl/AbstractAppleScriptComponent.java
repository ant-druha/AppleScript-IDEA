...
public abstract class AbstractAppleScriptComponent extends AppleScriptPsiElementImpl implements AppleScriptComponent {
    ...
    public boolean isObjectProperty() {
        return getContext() instanceof AppleScriptRecordLiteralExpression || getContext() instanceof AppleScriptTargetRecordLiteral;
//        return false;
    }
    ...
    public boolean isScriptProperty() {
        ...
        PsiElement myDeclaration = getOriginalDeclaration();
        return myDeclaration != null && myDeclaration instanceof AppleScriptPropertyDeclaration;
    }

    @Override
    public boolean isVariable() {
        if ((findChildByType(AppleScriptTypes.LOCAL) != null
                || findChildByType(AppleScriptTypes.GLOBAL)!=null)
                || (this instanceof AppleScriptTargetVariable && getFirstChild() instanceof AppleScriptComponentName) || this instanceof
        ...
        ItemPresentation presentation = new AppleScriptElementPresentation(this) {
            ...
            public String getPresentableText() {
                ...
                if (isScriptProperty()) {
                    ...
                    result.append(getName());
                    AppleScriptHandlerPositionalParametersDefinition handler = (AppleScriptHandlerPositionalParametersDefinition) thisComponent;
