...
import com.idea.plugin.applescript.lang.resolve.AppleScriptComponentResolver;
 ...
 */
public class AppleScriptReferenceElementImpl extends AppleScriptExpressionImpl implements AppleScriptReferenceElement, PsiPolyVariantReference {
    ...
    public Object[] getVariants() {
        final List<? extends PsiElement> elements =
                ResolveCache.getInstance(getProject()).resolveWithCaching(this, AppleScriptComponentResolver.INSTANCE, true, true);
