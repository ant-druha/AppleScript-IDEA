...
public class AppleScriptCoercionBuiltInExpressionImpl extends AppleScriptExpressionImpl implements AppleScriptCoercionBuiltInExpression {

  public AppleScriptCoercionBuiltInExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof AppleScriptVisitor) ((AppleScriptVisitor)visitor).visitCoercionBuiltInExpression(this);
  ...
  public AppleScriptBuiltInClassName getBuiltInClassName() {
    return findNotNullChildByClass(AppleScriptBuiltInClassName.class);
  }
