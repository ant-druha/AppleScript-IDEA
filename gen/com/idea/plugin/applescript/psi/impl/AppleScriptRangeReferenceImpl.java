...
public class AppleScriptRangeReferenceImpl extends AppleScriptPsiElementImpl implements AppleScriptRangeReference {

  public AppleScriptRangeReferenceImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof AppleScriptVisitor) ((AppleScriptVisitor)visitor).visitRangeReference(this);
